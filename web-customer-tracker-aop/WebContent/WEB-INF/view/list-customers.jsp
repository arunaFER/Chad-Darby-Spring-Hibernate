		...
		<div id="content">
			...
			<table>
				...
				<c:forEach var="tempCustomer" items="${customers}">
					...
					<!-- construct an update link for each customer with their id -->
					<c:url var="updateLink" value="/customer/showFormForUpdate">
						<!-- create a param and bind current customer id for each row-->
						<!-- and add param to var -->
						<c:param name="customerId" value="${tempCustomer.id}" />
					</c:url>
					
					
					<!-- construct a delete link for each customer with their id -->
